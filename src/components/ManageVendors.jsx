 ...
 <h1 className="text-3xl font-bold text-orange-500 mb-6 font-poppins">
      ...
      <div className="flex space-x-4 mb-6">
        <input
          ...
          className="border border-gray-700 p-2 rounded w-full bg-gray-800 text-white"
          value={searchQuery}
        ...
        <select
          ...
          onChange={handleInputChange}
          name="status"
          className="border border-gray-700 p-2 rounded w-1/4 bg-gray-800 text-white"
        >
      ...
      {selectedVendor && (
        <div className="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50">
          <div className="bg-gray-800 p-6 rounded shadow-lg max-w-md w-full border border-gray-700">
            <h3 className="text-xl font-semibold mb-4 text-gray-300">Vendor Details</h3>
            <p className="mb-2"><strong className="text-gray-400">Name:</strong> {selectedVendor.name}</p>
            <p className="mb-2"><strong className="text-gray-400">Email:</strong> {selectedVendor.email}</p>
            <p className="mb-2"><strong className="text-gray-400">Phone:</strong> {selectedVendor.phone}</p>
            <p className="mb-2"><strong className="text-gray-400">Location:</strong> {selectedVendor.location}</p>
            <p className="mb-2"><strong className="text-gray-400">Bikes:</strong> {selectedVendor.bikes}</p>
            <p className="mb-2"><strong className="text-gray-400">Status:</strong> {selectedVendor.status}</p>
            <button
