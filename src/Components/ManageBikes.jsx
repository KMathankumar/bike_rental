...
export default function ManageBikes() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        resetForm();
        setMessage({ type: "success", text: "✅ Bike added successfully!" });
      } else {
        setMessage({ type: "error", text: result.message || "❌ Failed to add bike." });
      }
    } catch (err) {
  ...
  return (
    <div className="space-y-6 p-6 max-w-7xl mx-auto">
              ...
              <div key={bike._id} className="bg-white rounded-lg shadow overflow-hidden border border-gray-200">
                ...
                <div className="px-4 pb-2">
                  <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                    ...
                    <div><span className="text-gray-500">Fuel:</span> {bike.fuel || "Yes"}</div>
      ...
      {/* Add New Bike Form Tab */}
      {activeTab === "add" && (
        <div className="bg-white rounded-lg shadow border border-gray-200">
          <div className="p-6 border-b border-gray-200">
            <h3 className="text-lg font-semibold">Add New Bike</h3>
            <p className="text-sm text-gray-500">Fill in the details to add a new bike to your inventory</p>
          </div>
          <div className="p-6">
            {message.text && (
              <div
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 space-y-2">
                  ...
                  <div className="flex items-center justify-center w-full">
                    <label className="w-full h-32 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:bg-gray-50 flex flex-col items-center justify-center">
                      <div className="flex flex-col items-center justify-center pt-5 pb-6">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="w-8 h-8 mb-2 text-gray-500">
                      ...
                      <input type="file" name="img" accept="image/*" className="hidden" onChange={handleChange} />
                    </label>
                  </div>
                </div>
              </div>
